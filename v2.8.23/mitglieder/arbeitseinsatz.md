...
In den betroffenen [Beitragsgruppen](broken-reference) wird die Anzahl der Pflichtstunden und der Betrag für nicht erbrachte Stunden hinterlegt
...
* über das Kontextmenü eines Mitglieds (siehe [Mitglieder](broken-reference))
...
![](<../../v3.0.x/mitglieder/img/ArbeitseinsatzView (1).png>)
