...
Über die Buchungsklasse in den [Anlagenkonten](broken-reference) lässt sich eine Gruppierung erreichen.
...
Die Buchwerte zu Anfang und Ende des Geschäftsjahres werden aus den Anfangsbeständen der Anlagenkonten genommen. Es ist also wichtig, dass beim [Jahresabschluss](broken-reference) die Checkbox für Anfangsbestände Folgejahr ausgewählt ist. Damit werden die Anfangsbestände generiert.
