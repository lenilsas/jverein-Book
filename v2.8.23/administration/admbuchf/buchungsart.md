...
![](<../../../v3.0.x/administration/admbuchf/img/Buchungsartenpdf (1).png>)
...
![](<../../../v3.0.x/administration/admbuchf/img/Buchungsart (1).png>)
...
In JVerein gibt es ab 2.8.23 die Möglichkeit die feste Zuordnung zwischen Buchungsart und Buchungsklasse aufzuheben. Hierzu gibt es einen neuen Schalter in Administration->Einstellungen->[Buchführung](broken-reference).
