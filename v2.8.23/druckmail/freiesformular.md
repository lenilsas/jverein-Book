...
![](<../../v3.0.x/druckmail/img/FreieFormulareDruckMailView (1).png>)
...
Im Parameter Feld "Formular" ist ein freies Formular auszuwählen. Dieses muss gegebenenfalls erstellt werden. Siehe [Formulare](broken-reference).
